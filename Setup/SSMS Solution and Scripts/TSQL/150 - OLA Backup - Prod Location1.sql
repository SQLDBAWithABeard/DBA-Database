 ...
 the Data Centre 1 PRODUCTION Share Change this  - Line 6 & Line 85
 */
 
 DECLARE @DataCentre nvarchar(50) = 'Data Centre 1' -- Enter description for Agent jobs
...
END
  ...
  SET @JobOwner = SUSER_SNAME(0x01)
    ...
    SET @JobName01 = 'DatabaseBackup - SYSTEM_DATABASES - FULL - PROD ' + @DataCentre 
...
EXEC msdb.dbo.sp_delete_job @job_name=@JobName01 , @delete_unused_schedule=1
  ...
  SET @JobName02 = 'DatabaseBackup - USER_DATABASES - DIFF - PROD ' + @DataCentre 
...
EXEC msdb.dbo.sp_delete_job @job_name=@JobName02 , @delete_unused_schedule=1
  ...
  SET @JobName03 = 'DatabaseBackup - USER_DATABASES - FULL - PROD ' + @DataCentre 
...
EXEC msdb.dbo.sp_delete_job @job_name=@JobName03 , @delete_unused_schedule=1
 ...
 SET @JobName04 = 'DatabaseBackup - USER_DATABASES - LOG - PROD ' + @DataCentre 
