...
/****** Object:  Job [!DBA Database Server info]    Script Date: 15/05/2016 10:29:44 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [!DBA Database Jobs]    Script Date: 15/05/2016 10:29:44 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'!DBA Database Server info', 
		@enabled=1, 
		...
		@notify_level_page=0, 
		@delete_level=0, 
		@description=N'This job will returns all the server information from the Servers in the dbo.InstanceList table in the DBA Database. It writes to a log file located LogFiles\DBADatabaseSQLServerUpdate_''', 
		@category_name=N'!DBA Database Jobs', 
		@owner_login_name=N'sa', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Gather Data]    Script Date: 15/05/2016 10:29:44 ******/
