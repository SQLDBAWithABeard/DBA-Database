...
GO
ALTER TABLE [dbo].[ClientDatabaseLookup] ADD CONSTRAINT [FK_ClientDatabaseLookup_InstanceList] FOREIGN KEY ([InstanceID]) REFERENCES [dbo].[InstanceList] ([InstanceID])
GO
